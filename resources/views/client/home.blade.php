...
@section('content')
    ...
    <div class="w3_content_agilleinfo_inner">
        <div class="agile_featured_movies">
            ...
            <!--//tab-section-->
            <h3 class="agile_w3_title"> Phim Mới <span>Nhất</span></h3>
            <!--/movies-->
            ...
            <!--//movies-->
            <h3 class="agile_w3_title">Phim <span>Đề Xuất</span> </h3>
            <!--/requested-movies-->
            ...
            <!--//requested-movies-->
            <!--/top-movies-->
            <h3 class="agile_w3_title">Top <span>Lượt Xem</span> </h3>
                    ...
                    <div class="w3_agile_featured_movies two">
                        ...
                        <div class="col-md-5 video_agile_player second-top">
                            ...
                            <div class="player-text two">
                                ...
                                <p class="fexi_header_para"><span class="conjuring_w3">Mô tả<label>:</label></span>
                                    {{ $top_1_movie->description }}
                                </p>
                                <p class="fexi_header_para">
                                    <span>Sản xuất<label>:</label></span>{{ $top_1_movie->released }}
                                </p>
                                <p class="fexi_header_para">
                                    <span>Quốc gia<label>:</label></span>{{ $top_1_movie->national }}
                                </p>
                                <p class="fexi_header_para">
                                    <span>Thời gian<label>:</label></span>{{ $top_1_movie->timing }}
                                </p>
                            </div>
                        </div>
                        <div class="clearfix"> </div>
