    ...
    <div class="py-12">
        <div class="max-w mx-auto sm:px-6 lg:px-8">
            ...
            <a href="{{ url('/admin/phim/restore') }}">
                <button type="button"
                    class="focus:outline-none text-white bg-red-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 ">Lịch
                    sử xóa</button>
            </a>
            <a href="{{ url('/admin/phim/them') }}">
                <button type="button"
                    class="focus:outline-none text-white bg-green-500 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2">Thêm
                    mới</button>
