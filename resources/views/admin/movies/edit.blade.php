            ...
            <div class="mt-10 sm:mt-0">
                <div class="md:grid md:gap-4">
                    <div class="mt-5 md:mt-0 md:col-span-2">
                        <form action="/admin/phim/sua/{{ $movie->slug }}" method="POST">
                            <div class="shadow overflow-hidden sm:rounded-md">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            ...
                                            <select id="id_category" name="id_category" autocomplete="id_category"
                                                ...
                                                {{-- <option value="">{{ $category_of_movie['category'] }}</option> --}}
                                                @foreach ($category as $item)
                                                    <option value="{{ $item->id }}"
                                                        @if (old('item') == $item->id || $item->id == $category_of_movie['id']) selected @endif>
                                                        {{ $item->category }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                            ...
                                            <input type="text" name="released" id="released"
                                                value="{{ $movie->released }}" autocomplete="address-level2"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            @error('released')
                                                <span class="font-medium text-red-700 p-1">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            ...
                                            <input type="text" name="national" id="national"
                                                value="{{ $movie->national }}" autocomplete="address-level2"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            @error('national')
                                                <span class="font-medium text-red-700 p-1">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="status"
                                                class="block text-sm font-medium text-gray-700">Trạng thái
                                            </label>
                                        ...
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            ...
                                            <input type="file" name="link_img" id="link_img"
                                                value="{{ $movie->link_img }}" autocomplete="address-level2"
                                        ...
                                        <div class="col-span-6 sm:col-span-6 lg:col-span-6">
                                            ...
                                            <textarea id="message" rows="4" name="description" aria-valuetext="{{ $movie->description }}"
                                ...
                                <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                    <button type="submit"
                                        class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Cập
                                        nhật
                                    </button>
                                </div>
                            </div>
